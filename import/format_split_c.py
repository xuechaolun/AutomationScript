                ...
                if left_ip_list[3] == '000' and right_ip_list[3] == '255':
                    ...
                    if left_ip_list[2] == right_ip_list[2]:
                        ...
                        if int(right_ip_list[2]) - int(left_ip_list[2]) > 1:
                            mid_l = '.'.join(
                                [left_ip_list[0], left_ip_list[1], f'{(int(left_ip_list[2]) + 1):0>3d}', '000'])
                            mid_r = '.'.join(
                                [right_ip_list[0], right_ip_list[1], f'{(int(right_ip_list[2]) - 1):0>3d}', '255'])
